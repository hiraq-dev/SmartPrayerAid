...
public class CaldroidFragment extends DialogFragment {
	...
	public void setMinDate(Date minDate) {
		...
		//	Context context;
			//Toast.makeText(CaldroidFragment,minDate,Toast.LENGTH_LONG).show();
		}
	}
	...
	protected void refreshMonthTitleTextView() {
		...
		String hijrimonthtitle;
		 ...
		 if (HijriCalendarDate.getSimpleDateMonth(Qurancal,0)=="محرم" ) {
			 int year= Integer.parseInt(HijriCalendarDate.getSimpleDateYear(Qurancal,0))+1;

			 hijrimonthtitle = "ذوالحجة" +"-"+HijriCalendarDate.getSimpleDateMonth(Qurancal, 0) + " " + HijriCalendarDate.getSimpleDateYear(Qurancal, 0) + "-" + String.valueOf(year);
			 hijrimonthTitleTextView.setText(hijrimonthtitle);
		 }
		else if (HijriCalendarDate.getSimpleDateMonth(Qurancal,0)=="ذوالحجة") {
			hijrimonthtitle = "ذو القعدة" +"-"+HijriCalendarDate.getSimpleDateMonth(Qurancal, 0) + " " + HijriCalendarDate.getSimpleDateYear(Qurancal, 0);
			hijrimonthTitleTextView.setText(hijrimonthtitle);
		}
		 else if (HijriCalendarDate.getSimpleDateMonth(Qurancal,0)=="ذو القعدة" ) {
			 hijrimonthtitle = "شَوّال" +"-"+HijriCalendarDate.getSimpleDateMonth(Qurancal, 0) + " " + HijriCalendarDate.getSimpleDateYear(Qurancal, 0);
			 hijrimonthTitleTextView.setText(hijrimonthtitle);
		 }

		 else if (HijriCalendarDate.getSimpleDateMonth(Qurancal,0)== "شَوّال" ) {
			 hijrimonthtitle = "رَمَضان" +"-"+HijriCalendarDate.getSimpleDateMonth(Qurancal, 0) + " " + HijriCalendarDate.getSimpleDateYear(Qurancal, 0);
			 hijrimonthTitleTextView.setText(hijrimonthtitle);
		 }

		 else if (HijriCalendarDate.getSimpleDateMonth(Qurancal,0)== "رَمَضان" ) {
			 hijrimonthtitle = "شَعْبَان" +"-"+HijriCalendarDate.getSimpleDateMonth(Qurancal, 0) + " " + HijriCalendarDate.getSimpleDateYear(Qurancal, 0);
			 hijrimonthTitleTextView.setText(hijrimonthtitle);
		 }

		 else if (HijriCalendarDate.getSimpleDateMonth(Qurancal,0)== "شَعْبَان" ) {
			 hijrimonthtitle = "رَجَب" +"-"+HijriCalendarDate.getSimpleDateMonth(Qurancal, 0) + " " + HijriCalendarDate.getSimpleDateYear(Qurancal, 0);
			 hijrimonthTitleTextView.setText(hijrimonthtitle);
		 }
		 else if (HijriCalendarDate.getSimpleDateMonth(Qurancal,0)== "رَجَب" ) {
			 hijrimonthtitle = "جَمَادِي الثَّانِي" +"-"+HijriCalendarDate.getSimpleDateMonth(Qurancal, 0) + " " + HijriCalendarDate.getSimpleDateYear(Qurancal, 0);
			 hijrimonthTitleTextView.setText(hijrimonthtitle);
		 }

		 else if (HijriCalendarDate.getSimpleDateMonth(Qurancal,0)== "جَمَادِي الثَّانِي" ) {
			 hijrimonthtitle = "جَمَادِي الأَوّل" +"-"+HijriCalendarDate.getSimpleDateMonth(Qurancal, 0) + " " + HijriCalendarDate.getSimpleDateYear(Qurancal, 0);
			 hijrimonthTitleTextView.setText(hijrimonthtitle);
		 }
		 else if (HijriCalendarDate.getSimpleDateMonth(Qurancal,0)== "جَمَادِي الأَوّل" ) {
			 hijrimonthtitle = "رَبِيْعُ الثَّانِي" +"-"+HijriCalendarDate.getSimpleDateMonth(Qurancal, 0) + " " + HijriCalendarDate.getSimpleDateYear(Qurancal, 0);
			 hijrimonthTitleTextView.setText(hijrimonthtitle);
		 }
		 else if (HijriCalendarDate.getSimpleDateMonth(Qurancal,0)== "رَبِيْعُ الثَّانِي") {
			 hijrimonthtitle = "صَفَر" +"-"+HijriCalendarDate.getSimpleDateMonth(Qurancal, 0) + " " + HijriCalendarDate.getSimpleDateYear(Qurancal, 0);
			 hijrimonthTitleTextView.setText(hijrimonthtitle);
		 }
		 else if (HijriCalendarDate.getSimpleDateMonth(Qurancal,0)== "صَفَر") {
			 hijrimonthtitle = "مُحَرَّم" +"-"+HijriCalendarDate.getSimpleDateMonth(Qurancal, 0) + " " + HijriCalendarDate.getSimpleDateYear(Qurancal, 0);
			 hijrimonthTitleTextView.setText(hijrimonthtitle);
		 }
			 ...
			 hijrimonthtitle = HijriCalendarDate.getSimpleDateMonth(Qurancal, 0) + " " + HijriCalendarDate.getSimpleDateYear(Qurancal, 0);
			 hijrimonthTitleTextView.setText(hijrimonthtitle);

		 }


		//	String hijrimonthtitle = HijriCalendarDate.getSimpleDateMonth(Qurancal,0) + " " + HijriCalendarDate.myglobal.myyear;
	...
	public class DatePageChangeListener implements OnPageChangeListener {
		...
		public void onPageSelected(int position) {
			...
			setCalendarDateTime(currentDateTime);
			//Toast.makeText(,currentDateTime,Toast.LENGTH_LONG).show();
