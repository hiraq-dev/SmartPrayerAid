...
public final class HijriCalendarDate {

	public final static String[] WEEKDAYS = {  "Ahad", "Ithnin", "Thulatha", "Arbaa", "Khams", "Jumuah", "Sabt" };
	public final static String[] MONTHS = {"مُحَرَّم", "صَفَر", "رَبِيْعُ الأَوّل", "رَبِيْعُ الثَّانِي", "جَمَادِي الأَوّل", "جَمَادِي الثَّانِي", "رَجَب", "شَعْبَان", "رَمَضان", "شَوّال", "ذو القعدة", "ذوالحجة", "\u0645\u062d\u0631\u0645", " \u0635\u0641\u0631", " \u0631\u0628\u064a\u0639 \u0627\u0644\u0623\u0648\u0644", " \u0631\u0628\u064a\u0639 \u0627\u0644\u062b\u0627\u0646\u064a", " \u062c\u0645\u0627\u062f\u064a \u0627\u0644\u0623\u0648\u0644", " \u062c\u0645\u0627\u062f\u064a \u0627\u0644\u062b\u0627\u0646\u064a", " \u0631\u062c\u0628", " \u0634\u0639\u0628\u0627\u0646", " \u0631\u0645\u0636\u0627\u0646\u00a0", " \u0634\u0648\u0627\u0644", " \u0630\u0648 \u0627\u0644\u0642\u0639\u062f\u0629\u00a0", " \u0630\u0648 \u0627\u0644\u062d\u062c\u0629", "مُحَرَّم", "صَفَر", "رَبِيْعُ الأَوّل\u2019", "رَبِيْعُ الثَّانِي\u2019", "جَمَادِي الأَوّل", "جَمَادِي الثَّانِي", "رَجَب", "شَعْبَان\u2019", "رَمَضان", "شَوّال", "ذو القعدة", "ذو الحجة"};
	...
	public static class myglobal{
		...
		public static double myyear,mymonth;
	}
  ...
  /* if(valuechange==-2) {
	...
	/*	day = day + valuechange;
		...
		double jgc = a - Math.floor(a / 4) - 2;//b
		...
		//day= Integer.parseInt(writeIslamicDate());
		...
		if (valuechange==0) {
			...
			long todaymili = cal.getTimeInMillis() ;
		...
		month= im;
		year=iy;
		myglobal.myyear=year;
		myglobal.mymonth=month;
	...
	public static String getSimpleDateDay(Calendar cal) {
		int[] dt=ummalQuraCalendar(cal);
	...
	public static String getSimpleDateMonth(Calendar cal) {
	...
	public static String getSimpleDateYear(Calendar cal) {
		int[] dt = ummalQuraCalendar(cal);
		return String.valueOf(dt[3]);
	}*/
...
/*
		if(valuechange.equals("minus2")) {
			...
			day = day - 1;
		}else if (valuechange.equals("plus1")) {
			day = day + 1;
	...
	static double[] kuwaiticalendar(boolean adjust) {
		...
		double day = today.get(Calendar.DATE);
		...
		myRes[2] = year; // calculated year (CE)f
	...
	static String writeIslamicDate() {
		...
		//String outputIslamicDate = wdNames[(int) iDate[4]] + ", " + iDate[5] + " "+ iMonthNames[(int) iDate[6]] + " " + iDate[7] + " AH";

		//myglobal.myyear= (String.valueOf(iDate[7]));
	String outputIslamicDate =  String.valueOf(iDate[7]).split("\\.")[0];
